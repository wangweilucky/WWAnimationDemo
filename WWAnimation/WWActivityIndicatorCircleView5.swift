//
//  WWActivityIndicatorCircleView5.swift
//  WWAnimation
//
...
class WWActivityIndicatorCircleView5: UIView {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        let beginTimes : [CFTimeInterval] = [0.1, 0.3, 0.1]
        let timingFunciton = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseInEaseOut)
        
        let animationB = CAKeyframeAnimation(keyPath: "opacity")
        animationB.values = [1, 0.3 , 1]
